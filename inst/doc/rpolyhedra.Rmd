...
---
#Introduction
This package is a curation made based on based on the poly package found on http://www.netlib.org/polyhedra/ ([Original Help message](poly_original_help_message.html)), and the polyhedra database found on https://www.dmccooey.com/polyhedra, both of which provide a library of polyhedron and its representation. As such, Rpolyhedra provides with the following:
