...
[![Downloads](http://cranlogs.r-pkg.org/badges/grand-total/Rpolyhedra?color=brightgreen)](https://www.r-pkg.org:443/pkg/Rpolyhedra)
 ...
 This package is a polyhedra database based on the poly package found on http://www.netlib.org/polyhedra/ ([Original Help message](https://github.com/ropensci/Rpolyhedra/tree/master/poly_original_help_message.html)), and the polyhedra definitions found on http://dmccooey.com/polyhedra/. As such, Rpolyhedra provides with the following:
