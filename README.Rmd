...
### netlib
 ...
 PHD files were generated using [poly2](https://www.netlib.org/poly2/readme) library (no longer maintained). Although the code is available, specific programming skills are required to run it.
